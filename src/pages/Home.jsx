...
const Home = () => {
    useEffect(() => {
        // Function to scroll to the section if the URL hash is present
        ...
        // Scroll to section if the URL hash is present on initial load
        scrollToSection();
  ...
  return (
    <>
    <div className="hero">
      <Parallax className="hero-img" strength={100} bgImage="img/banner2.jpg">
